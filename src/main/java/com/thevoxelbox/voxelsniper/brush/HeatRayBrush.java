...
public class HeatRayBrush extends Brush
{
    ...
    private static final ArrayList<Material> FLAMABLE_BLOCKS = Arrays.stream(Material.values()).filter(Material::isFlammable).collect(Collectors.toCollection(ArrayList::new));
