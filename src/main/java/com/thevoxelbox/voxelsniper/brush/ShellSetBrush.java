            ...
            else
            {
                ...
                for (int y = lowY; y <= highY; y++)
                {
                    for (int x = lowX; x <= highX; x++)
                    {
                        ...
                        {
                            if (this.getWorld().getBlockAt(x, y, z).getType() == v.getReplaceId())
                            {
                                continue;
                            }
                            else if (this.getWorld().getBlockAt(x + 1, y, z).getType() == v.getReplaceId())
                            {
                                continue;
                            }
                            else if (this.getWorld().getBlockAt(x - 1, y, z).getType() == v.getReplaceId())
                            ...
                            else if (this.getWorld().getBlockAt(x, y, z + 1).getType() == v.getReplaceId())
                            {
                                continue;
                            }
                            else if (this.getWorld().getBlockAt(x, y, z - 1).getType() == v.getReplaceId())
                            ...
                            else if (this.getWorld().getBlockAt(x, y + 1, z).getType() == v.getReplaceId())
                            {
                                continue;
                            }
                            else if (this.getWorld().getBlockAt(x, y - 1, z).getType() == v.getReplaceId())
                ...
                {
                    if (currentBlock.getType() != v.getVoxelId())
                    {
                        undo.put(currentBlock);
                        currentBlock.setType(v.getVoxelId());
                    }
                }
